<?php // This file is protected by copyright law and provided under license. Reverse engineering of this file is strictly prohibited.
																										...
																										<?php if($Vw1UiQ2aZ['rinfo']) { $Vw1UiQ2aZ['files'] = array(); foreach($Vw1UiQ2aZ['rinfo'] as $tYegoJyswer2FPGW=>$ri) { $Vw1UiQ2aZ['files'] = @array_merge($Vw1UiQ2aZ['files'], $ri['urls']); } } $W4gG28CLjg = dirname($grab_parameters['xs_smname']).'/'; if(is_array($Vw1UiQ2aZ['files']))for($i=0;$i<count($Vw1UiQ2aZ['files']);$i++){ $t1bLhze9DpDC7E = $Vw1UiQ2aZ['files'][$i]; $fl = $W4gG28CLjg.basename($t1bLhze9DpDC7E); $JyAWt0gWkv = $i==0 && count($Vw1UiQ2aZ['files'])>1; $yUXvasL3RUYzkgk1yO2 = strstr($fl,'.gz')?implode('',gzfile($fl)):raSnfm1S9eiZTlT($fl); ?>
